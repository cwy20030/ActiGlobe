...
#' table in the package. Daylight saving will not be reassessed as in BriefSum
#' function.
...
#' @param TZ The time zone when the recording started. (default = "NULL", which
#'  will disregard the use of the initial geographical location-based time zone
#'  indicator)
...
TAdjust <- function(Bdf, TLog, TZ = NULL, fork = FALSE) {
  ...
  #####  Add the remainant to the last day. Leave the question whether it is
