...
<div class="fullsize-scroll">
  <h5 class="image-title">Table 2 The Header of Bdf</h5>
...
head(data) ### This should give us the same first few lines of FlyEast dataset with a few new columns created by [BrifSum()].
```
...
<div class="fullsize-scroll">
  <h5 class="image-title">Table 6 Initial Brief Summary of the Recording</h5>
...
<div class="fullsize-scroll">
  <h5 class="image-title"> Table 7. Adjusted Brief Summary of the Recording</h5>
