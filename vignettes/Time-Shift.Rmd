...
```{r message=FALSE, warning=FALSE,echo=FALSE, out.width="30%", paged.print=TRUE}
...
![Bdf_head](./images/Bdf_head.png){width=600}
...
```
![Bdf_demo](./images/Bdf_demo.png){width=600}
...
ggActiGlobe(df = df, 
            ...
            VDT = "DateTime")
```
![Unadjusted_Overview](./images/Unadjusted_Overview.png){width=600}
