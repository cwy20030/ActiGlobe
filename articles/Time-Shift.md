...
actigraphy measures, please go to other
...
\< Tip for Beginner to R\> Type: View(FlyEast) in the R console will
allow users to review the data structure of FlyEast.
